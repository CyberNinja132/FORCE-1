...
function draw() {
  ...
  keypressed();
  textSize(45);
  text("press upper arrow for some FORCE", 10,100);
  text("press other keys to deflect the FORCE", 10,200)
...
function keypressed(){
	if(keyCode === UP_ARROW) {
		Matter.Body.applyForce(bob1.body,bob1.body.position,{x:-18,y:15});
	}
}
